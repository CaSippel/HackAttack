...
var lock5= new PatternLock('#patternHolder5',{matrix:[4,4],initialPattern : [1,2,3]});
var lock6= new PatternLock('#patternHolder6',{
        	mapper: function(idx){
        		return (idx%9) + 1;
       		},
			onDraw:function(pattern){
...
var lock7 =new PatternLock('#patternHolder7');
}());;
(function(){
	var patternId,
